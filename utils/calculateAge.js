...
const calculateAge = (dob) => {
  // If dob is missing, null, or not a string, return a placeholder
  ...
  try {
    ...
    if (isNaN(bsYear)) return "N/A";

    // Your existing logic here...
    // Example placeholder logic:
    const currentYear = 2081; // Current BS Year approx
    return currentYear - bsYear;
  } catch (error) {
    return "N/A";
  }
};
